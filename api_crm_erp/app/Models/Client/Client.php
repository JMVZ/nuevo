...
use Askedio\SoftCascade\Traits\SoftCascadeTrait;  // ¡Importa el trait!
...
class Client extends Model
{
    ...
    /** Un cliente tiene muchas proformas */
    public function proformas()
    {
        return $this->hasMany(\App\Models\Proforma\Proforma::class);
    }
